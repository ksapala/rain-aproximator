...
public class ComparatorModeAccuracyTest {
    ...
    private Aproximation create(AproximationResultType type, double rSquare, int pointsCount, String time) {
        AproximationResult aproximationResult = new AproximationResult(type, TestUtils.time(time));
    ...
    public void testCompareRSquareAndWeatherDominance() {
        ...
        results.add(create(AproximationResultType.SUN_GOES_AWAY, 0.9, 10));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 0.9, 10));
        ...
        assertEquals(create(AproximationResultType.SUN_GOES_AWAY, 0.9, 10), results.get(8));
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 0.9, 10), results.get(9));
    ...
    public void shouldComparePlaceInnacurateAsLast() {
        ...
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 2));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 3));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 0.9, 10));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 10));
        ...
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 10), results.get(2));
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 0.9, 10), results.get(3));
        ...
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 3), results.get(8));
        assertEquals(create(AproximationResultType.RAIN_AT_TIME, 1.0, 2, "28-04-2015 12:00"), results.get(9));
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 1.0, 2), results.get(10));
    }
    ...
    public void shouldCompareHeavyRainUnsure() {
        ...
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 0.988, 10));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 0.7, 10));
        results.add(create(AproximationResultType.RAIN_GOES_AWAY, 0.7, 10));
        ...
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 0.988, 10), results.get(1));
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 0.7, 10), results.get(2));
        assertEquals(create(AproximationResultType.RAIN_GOES_AWAY, 0.7, 10), results.get(3));
    }
}
